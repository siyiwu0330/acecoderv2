...
DATASET_NAME="CodeDPO/AceCoderV2-150K-processed"
MAX_SAMPLES=500 # set to 0 for all samples
MODEL_NAME="o1-mini"
SAVE_BATCH_SIZE=25
MAX_CONCURRENT=25
# GEN_MODEL="Qwen/Qwen3-8B"
GEN_MODEL="Qwen/Qwen2.5_Coder_32B_Instruct"
...
python step2.2_eval.py $STEP2_1_OUTPUT --overwrite $OVERWRITE --max_samples $MAX_SAMPLES
